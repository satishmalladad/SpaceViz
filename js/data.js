...
const PRODUCTS = [
  ...
  { id: 7, name: "Edison Cage Pendant", category: "lamp", price: 680, emoji: "🔆", desc: "Industrial cage pendant with filament bulb.", badge: null, style: "industrial", color: "black", width: 30, model: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
  { id: 8, name: "Monstera Deliciosa", category: "plant", price: 299, emoji: "🌿", desc: "Statement plant in terracotta pot.", badge: "new", style: "organic", color: "green", width: 60, model: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
  { id: 9, name: "Fiddle Leaf Fig", category: "plant", price: 549, emoji: "🌳", desc: "Designer favourite indoor tree.", badge: null, style: "modern", color: "green", width: 50, model: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
  { id: 10, name: "Boucle Accent Chair", category: "decor", price: 1650, emoji: "🪑", desc: "Cloud-like boucle fabric chair.", badge: "sale", style: "modern", color: "cream", width: 80, model: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
  { id: 11, name: "Wabi-Sabi Mirror", category: "decor", price: 899, emoji: "🪞", desc: "Irregular shaped arch mirror.", badge: "new", style: "organic", color: "beige", width: 70, model: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
  { id: 12, name: "Linen Bookshelf", category: "decor", price: 2100, emoji: "📚", desc: "Modular open shelving unit.", badge: null, style: "modern", color: "oak", width: 120, model: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" }
];
...
const AI_PROFILES = [
  ...
  { style: "industrial", weight: { industrial: 3 } }
];

const AI_MESSAGES = [
  "Analyzing your room dimensions and lighting...",
  "Cross-referencing 500+ furniture pieces...",
  "Matching color temperatures to ambient light...",
